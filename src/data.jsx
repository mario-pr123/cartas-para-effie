...
export const FICHA = [
  { title: "Música y baile", items: [
    ...
    ["♫", "var(--blush)", <>Te encanta <b>Juan Gabriel</b>, aunque yo no lo hago pero por ti lo haré jaja.</>],
  ...
  { title: "Lectura y cine", items: [
    ["❦", "var(--mint)", <>Te gusta <b>leer</b>. Tenías un TikTok donde subías videos leyendo. Ahora me vas a tener que leer todas las noches xD</>],
    ["✉", "var(--mint)", <>Tu película favorita es <b>Orgullo y prejuicio</b> (2005). Hoy la vemos juntos.</>]
  ]},
  { title: "En el hotel", items: [
    ["☆", "var(--lilac)", <>Eres muy <b>creativa</b>, y se nota con tus looks.</>],
